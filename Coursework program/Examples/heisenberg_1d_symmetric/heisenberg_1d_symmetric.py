...
energy_mean(num=1, filename=filename, title="Heisenberg model", exact=exact)
relative_error(num=2, filename=filename, title="Heisenberg model", exact=exact)
sgd(num=3, filename=filename, title="Heisenberg model")
plt.show()
