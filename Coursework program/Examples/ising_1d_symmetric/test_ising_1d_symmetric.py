...
energy_mean(num=1, filename="test_ising_1d_symmetric", title="Ising1dSymmetric", exact=-25.490989686360003)
relative_error(num=2, filename="test_ising_1d_symmetric", title="Ising1dSymmetric", exact=-25.490989686360003)
sgd(num=3, filename="test_ising_1d_symmetric", title="Ising1dSymmetric")
plt.show()
